...
class TestBuilder(unittest.TestCase):
    ...
    def test_elements(self):
        ...
        datasets = [
            ('instrument/chopper/freqs',
             [10.1, 10.3], 'float', [('units', 'Hz')]),
        ...
        streams = [
            ('sample/some_temp', 'sics_stream', 'sample/some_temp',
             'f142', 'float', 12.3, [('units', 'Deg')]),
            ('sample/fixed_temp', 'sics_stream', 'sample/fixed_temp',
                'sval', 'float', 0.0, [('units', 'Deg C')])
        ]
